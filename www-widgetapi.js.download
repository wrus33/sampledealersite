...
function pa(a,b){a.m={X:b,sa:!0};a.h=a.j||a.u}
...
function ua(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.o=!1,{value:b.value,done:!1}}catch(c){a.h.i=void 0,pa(a.h,c)}a.h.o=!1;if(a.h.m){b=a.h.m;a.h.m=null;if(b.sa)throw b.X;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
;function Ja(a,b){if(Error.captureStackTrace)Error.captureStackTrace(this,Ja);else{var c=Error().stack;c&&(this.stack=c)}a&&(this.message=String(a));b&&(this.ja=b)}
...
return a}
var Ub={xa:"allow-forms",ya:"allow-modals",za:"allow-orientation-lock",Aa:"allow-pointer-lock",Ba:"allow-popups",Ca:"allow-popups-to-escape-sandbox",Da:"allow-presentation",Ea:"allow-same-origin",Fa:"allow-scripts",Ga:"allow-top-navigation",Ha:"allow-top-navigation-by-user-activation"},Wb=La(function(){return Vb()});
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,ka:function(){for(var n=d(),r="",p=0;p<n.length;p++)r+="0123456789ABCDEF".charAt(Math.floor(n[p]/16))+"0123456789ABCDEF".charAt(n[p]%16);return r}}}
...
function cc(a){var b=$b();b.update(a);return b.ka().toLowerCase()}
...
function Dc(a,b){b||(b={});b[Fc(a)]=!0;var c=a.stack||"";(a=a.ja)&&!b[Fc(a)]&&(c+="\nCaused by: ",a.stack&&0==a.stack.indexOf(a.toString())||(c+="string"===typeof a?a:a.message+"\n"),c+=Dc(a,b));return c}
...
function de(a){var b=C("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=R("ERRORS",[]),b.push([a,"ERROR",void 0,void 0,void 0]),$d("ERRORS",b));be(a)}
...
function Kf(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||R("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Ja||R("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Ia:b=ic([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=R("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=R("DELEGATED_SESSION_ID")));return d}
...
function Xf(){var a;return null===(a=Wf())||void 0===a?void 0:a.get("LAST_RESULT_ENTRY_KEY",!0)}
function Yf(a,b,c){this.h=void 0===a?!1:a;this.failureMessage=b;this.j=c;(a=Xf())||(a={createdTimestampMs:T(),isSupported:this.h,resultCount:0,hasSucceededOnce:this.h});this.i=a;var d;if(Zf()){var e;this.i.isSupported===this.h?e=Object.assign(Object.assign({},this.i),{resultCount:this.i.resultCount+1}):e={isSupported:this.h,resultCount:1,createdTimestampMs:T(),hasSucceededOnce:this.i.hasSucceededOnce||this.h};null===(d=Wf())||void 0===d?void 0:d.set("LAST_RESULT_ENTRY_KEY",e,2592E3,!0)}}
function $f(a,b){return new Yf(!1,a instanceof Error?a.message:"",void 0===b?!1:b)}
Yf.prototype.isSupported=function(){return this.h};
Yf.prototype.log=function(){Zf()&&Vf("IS_SUPPORTED_COMPLETED",{isSupported:this.h,lastIsSupported:this.i.isSupported,failureMessage:this.failureMessage,sameResultCount:this.i.resultCount,sameResultDurationMs:Math.floor(T()-this.i.createdTimestampMs),canDetectDataOnFailure:this.j})};
function Zf(){var a;return!!(S("ytidb_analyze_is_supported")&&(null===(a=Wf())||void 0===a?0:a.h))}
;function ag(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);d=[];var e=d.concat;if(!(c instanceof Array)){c=u(c);for(var f,g=[];!(f=c.next()).done;)g.push(f.value);c=g}this.args=e.call(d,c)}
ma(ag,Error);function bg(a){return a.substr(0,a.indexOf(":"))||a}
;var cg={},dg=(cg.AUTH_INVALID="No user identifier specified.",cg.EXPLICIT_ABORT="Transaction was explicitly aborted.",cg.IDB_NOT_SUPPORTED="IndexedDB is not supported.",cg.MISSING_OBJECT_STORE="Object store not created.",cg.UNKNOWN_ABORT="Transaction was aborted for unknown reasons.",cg.QUOTA_EXCEEDED="The current transaction exceeded its quota limitations.",cg.QUOTA_MAYBE_EXCEEDED="The current transaction may have failed because of exceeding quota limitations.",cg.EXECUTE_TRANSACTION_ON_CLOSED_DB=
"Can't start a transaction on a closed database",cg),eg={},fg=(eg.AUTH_INVALID="ERROR",eg.EXECUTE_TRANSACTION_ON_CLOSED_DB="WARNING",eg.EXPLICIT_ABORT="IGNORED",eg.IDB_NOT_SUPPORTED="ERROR",eg.MISSING_OBJECT_STORE="ERROR",eg.QUOTA_EXCEEDED="WARNING",eg.QUOTA_MAYBE_EXCEEDED="WARNING",eg.UNKNOWN_ABORT="WARNING",eg),gg={},hg=(gg.AUTH_INVALID=!1,gg.EXECUTE_TRANSACTION_ON_CLOSED_DB=!1,gg.EXPLICIT_ABORT=!1,gg.IDB_NOT_SUPPORTED=!1,gg.MISSING_OBJECT_STORE=!1,gg.QUOTA_EXCEEDED=!1,gg.QUOTA_MAYBE_EXCEEDED=!0,
gg.UNKNOWN_ABORT=!0,gg);function U(a,b,c,d,e){b=void 0===b?{}:b;c=void 0===c?dg[a]:c;d=void 0===d?fg[a]:d;e=void 0===e?hg[a]:e;ag.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;this.level=d;this.h=e;Object.setPrototypeOf(this,U.prototype)}
ma(U,ag);function ig(a){U.call(this,"MISSING_OBJECT_STORE",{Oa:a},dg.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,ig.prototype)}
ma(ig,U);var jg=["The database connection is closing","Can't start a transaction on a closed database","A mutation operation was attempted on a database that did not allow mutations"];
function kg(a,b,c){b=bg(b);var d=a instanceof Error?a:Error("Unexpected error: "+a);if(d instanceof U)return d;if("QuotaExceededError"===d.name)return new U("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:b});if(Nb&&"UnknownError"===d.name)return new U("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:b});if("InvalidStateError"===d.name&&jg.some(function(e){return d.message.includes(e)}))return new U("EXECUTE_TRANSACTION_ON_CLOSED_DB",{objectStoreNames:c,
...
V.all=function(a){return new V(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={H:0};f.H<a.length;f={H:f.H},++f.H)ng(V.resolve(a[f.H]).then(function(g){return function(h){d[g.H]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})})};
V.resolve=function(a){return new V(function(b,c){a instanceof V?a.then(b,c):b(a)})};
V.reject=function(a){return new V(function(b,c){c(a)})};
V.prototype.then=function(a,b){var c=this,d=null!==a&&void 0!==a?a:mg,e=null!==b&&void 0!==b?b:lg;return new V(function(f,g){"PENDING"===c.state.status?(c.h.push(function(){og(c,c,d,f,g)}),c.onRejected.push(function(){pg(c,c,e,f,g)})):"FULFILLED"===c.state.status?og(c,c,d,f,g):"REJECTED"===c.state.status&&pg(c,c,e,f,g)})};
...
function sg(a){return new Promise(function(b,c){rg(a,b,c)})}
function W(a){return new V(function(b,c){rg(a,b,c)})}
;function tg(a,b){return new V(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
e()})}
;function ug(a){return new Promise(function(b){De(function(){b()},a)})}
function vg(a,b){this.h=a;this.options=b;this.transactionCount=0;this.j=Math.round(T());this.i=!1}
q=vg.prototype;q.add=function(a,b,c){return wg(this,[a],{mode:"readwrite",G:!0},function(d){return xg(d,a).add(b,c)})};
q.clear=function(a){return wg(this,[a],{mode:"readwrite",G:!0},function(b){return xg(b,a).clear()})};
q.close=function(){var a;this.h.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
q.count=function(a,b){return wg(this,[a],{mode:"readonly",G:!0},function(c){return xg(c,a).count(b)})};
q.delete=function(a,b){return wg(this,[a],{mode:"readwrite",G:!0},function(c){return xg(c,a).delete(b)})};
q.get=function(a,b){return wg(this,[a],{mode:"readonly",G:!0},function(c){return xg(c,a).get(b)})};
function wg(a,b,c,d){return L(a,function f(){var g=this,h,k,l,m,n,r,p,v,w,y,X,H,D,Q;return z(f,function(E){switch(E.h){case 1:var Ba={mode:"readonly",G:!1};"string"===typeof c?Ba.mode=c:Ba=c;h=Ba;g.transactionCount++;k=S("ytidb_transaction_exponential_backoff_retries");l=h.G?ze("ytidb_transaction_try_count",1):1;m=500;n=0;case 2:if(r){E.h=3;break}n++;p=Math.round(T());E.j=4;v=g.h.transaction(b,h.mode);Ba=new yg(v);Ba=zg(Ba,d);return x(E,Ba,6);case 6:return w=E.i,y=Math.round(T()),Ag(g,p,y,n,void 0,
b.join(),h),E.return(w);case 4:X=qa(E);H=Math.round(T());D=kg(X,g.h.name,b.join());if((Q=D instanceof U&&!D.h)||n>=l){Ag(g,p,H,n,D,b.join(),h);r=D;E.h=2;break}if(!k){E.h=2;break}return x(E,ug(m),9);case 9:m*=2;E.h=2;break;case 3:return E.return(Promise.reject(r))}})})}
function Ag(a,b,c,d,e,f,g){b=c-b;e?(e instanceof U&&("QUOTA_EXCEEDED"===e.type||"QUOTA_MAYBE_EXCEEDED"===e.type)&&Vf("QUOTA_EXCEEDED",{dbName:bg(a.h.name),objectStoreNames:f,transactionCount:a.transactionCount,transactionMode:g.mode}),e instanceof U&&"UNKNOWN_ABORT"===e.type&&(Vf("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:f,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c-a.j}),a.i=!0),Bg(a,!1,d,f,b),Uf||(Tf.push({type:"ERROR",payload:e}),10<Tf.length&&Tf.shift())):
Bg(a,!0,d,f,b)}
function Bg(a,b,c,d,e){Vf("TRANSACTION_ENDED",{objectStoreNames:d,connectionHasUnknownAbortedTransaction:a.i,duration:e,isSuccessful:b,tryCount:c})}
function Cg(a){this.h=a}
q=Cg.prototype;q.add=function(a,b){return W(this.h.add(a,b))};
q.clear=function(){return W(this.h.clear()).then(function(){})};
q.count=function(a){return W(this.h.count(a))};
function Dg(a,b){return Eg(a,{query:b},function(c){return c.delete().then(function(){return c.continue()})}).then(function(){})}
q.delete=function(a){return a instanceof IDBKeyRange?Dg(this,a):W(this.h.delete(a))};
q.get=function(a){return W(this.h.get(a))};
q.index=function(a){return new Fg(this.h.index(a))};
q.getName=function(){return this.h.name};
function Eg(a,b,c){a=a.h.openCursor(b.query,b.direction);return Gg(a).then(function(d){return tg(d,c)})}
function yg(a){var b=this;this.h=a;this.i=new Map;this.aborted=!1;this.done=new Promise(function(c,d){b.h.addEventListener("complete",function(){c()});
...
function zg(a,b){var c=new Promise(function(d,e){ng(b(a).then(function(f){a.commit();d(f)}),e)});
return Promise.all([c,a.done]).then(function(d){return u(d).next().value})}
yg.prototype.abort=function(){this.h.abort();this.aborted=!0;throw new U("EXPLICIT_ABORT");};
yg.prototype.commit=function(){var a=this.h;a.commit&&!this.aborted&&a.commit()};
function xg(a,b){b=a.h.objectStore(b);var c=a.i.get(b);c||(c=new Cg(b),a.i.set(b,c));return c}
function Fg(a){this.h=a}
Fg.prototype.count=function(a){return W(this.h.count(a))};
Fg.prototype.delete=function(a){return Hg(this,{query:a},function(b){return b.delete().then(function(){return b.continue()})})};
Fg.prototype.get=function(a){return W(this.h.get(a))};
Fg.prototype.getKey=function(a){return W(this.h.getKey(a))};
function Hg(a,b,c){a=a.h.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return Gg(a).then(function(d){return tg(d,c)})}
function Ig(a,b){this.request=a;this.cursor=b}
function Gg(a){return W(a).then(function(b){return null===b?null:new Ig(a,b)})}
q=Ig.prototype;q.advance=function(a){this.cursor.advance(a);return Gg(this.request)};
q.continue=function(a){this.cursor.continue(a);return Gg(this.request)};
q.delete=function(){return W(this.cursor.delete()).then(function(){})};
q.getKey=function(){return this.cursor.key};
q.update=function(a){return W(this.cursor.update(a))};function Jg(a,b,c){return L(this,function e(){var f,g,h,k,l,m,n,r,p,v;return z(e,function(w){if(1==w.h)return f=self.indexedDB.open(a,b),g=c,h=g.blocked,k=g.blocking,l=g.wa,m=g.upgrade,n=g.closed,p=function(){r||(r=new vg(f.result,{closed:n}));return r},f.addEventListener("upgradeneeded",function(y){if(null===y.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");
if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");y.dataLoss&&"none"!==y.dataLoss&&Vf("IDB_DATA_CORRUPTED",{reason:y.dataLossMessage||"unknown reason",dbName:bg(a)});var X=p(),H=new yg(f.transaction);m&&m(X,y.oldVersion,y.newVersion,H)}),h&&f.addEventListener("blocked",function(){h()}),x(w,sg(f),2);
v=w.i;k&&v.addEventListener("versionchange",function(){k(p())});
v.addEventListener("close",function(){Vf("IDB_UNEXPECTEDLY_CLOSED",{dbName:bg(a),dbVersion:v.version});l&&l()});
return w.return(p())})})}
function Kg(a,b){b=void 0===b?{}:b;return L(this,function d(){var e,f,g;return z(d,function(h){e=self.indexedDB.deleteDatabase(a);f=b;(g=f.blocked)&&e.addEventListener("blocked",function(){g()});
return x(h,sg(e),0)})})}
;function Lg(a){this.name="YtIdbMeta";this.options=a;this.i=!1}
function Mg(a,b,c){c=void 0===c?{}:c;c=void 0===c?{}:c;return Jg(a,b,c)}
Lg.prototype.delete=function(a){a=void 0===a?{}:a;return Kg(this.name,a)};
Lg.prototype.open=function(){var a=this;if(!this.h){var b,c=function(){a.h===b&&(a.h=void 0)},d={blocking:function(f){f.close()},
closed:c,wa:c,upgrade:this.options.upgrade},e=function(){return L(a,function g(){var h=this,k,l,m;return z(g,function(n){switch(n.h){case 1:return n.j=2,x(n,Mg(h.name,h.options.version,d),4);case 4:k=n.i;a:{var r=u(Object.keys(h.options.va));for(var p=r.next();!p.done;p=r.next())if(p=p.value,!k.h.objectStoreNames.contains(p)){r=p;break a}r=void 0}l=r;if(void 0===l){n.h=5;break}if(h.i){n.h=6;break}h.i=!0;return x(n,h.delete(),7);case 7:return n.return(e());case 6:throw new ig(l);case 5:return n.return(k);
case 2:m=qa(n);if(m instanceof DOMException?"VersionError"===m.name:"DOMError"in self&&m instanceof DOMError?"VersionError"===m.name:m instanceof Object&&"message"in m&&"An attempt was made to open a database using a lower version than the existing version."===m.message)return n.return(Mg(h.name,void 0,Object.assign(Object.assign({},d),{upgrade:void 0})));c();throw m;}})})};
this.h=b=e()}return this.h};var Ng=new Lg({va:{databases:!0},upgrade:function(a,b){1>b&&a.h.createObjectStore("databases",{keyPath:"actualName"})}});
function Og(a){return L(this,function c(){var d;return z(c,function(e){if(1==e.h)return x(e,Ng.open(),2);d=e.i;return e.return(wg(d,["databases"],{G:!0,mode:"readwrite"},function(f){var g=xg(f,"databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier||a.clearDataOnAuthChange!==h.clearDataOnAuthChange:1)return W(g.h.put(a,void 0)).then(function(){})})}))})})}
function Pg(){return L(this,function b(){var c;return z(b,function(d){if(1==d.h)return x(d,Ng.open(),2);c=d.i;return d.return(c.delete("databases","yt-idb-test-do-not-use"))})})}
function Qg(){return L(this,function b(){var c,d;return z(b,function(e){if(1==e.h)return x(e,Ng.open(),2);if(3!=e.h)return c=e.i,x(e,c.count("databases"),3);d=e.i;return e.return(0<d)})})}
;var Rg;
function Sg(){return L(this,function b(){var c,d,e,f,g;return z(b,function(h){switch(h.h){case 1:if(S("ytidb_is_supported_cache_success_result")&&(c=Xf(),null===c||void 0===c?0:c.hasSucceededOnce))return h.return(new Yf(!0));var k;if(k=Xe)k=/WebKit\/([0-9]+)/.exec(ib),k=!!(k&&600<=parseInt(k[1],10));k&&(k=/WebKit\/([0-9]+)/.exec(ib),k=!(k&&602<=parseInt(k[1],10)));if(k)return h.return($f(Error("YtIdb is not supported on iOS 8 or 9")));if(zb)return h.return($f(Error("YtIdb is not supported on Edge")));try{if(d=
self,!(d.indexedDB&&d.IDBIndex&&d.IDBKeyRange&&d.IDBObjectStore))return h.return($f(Error("Non-prefixed indexedDB APIs are missing")))}catch(l){return h.return($f(l))}if(!("IDBTransaction"in self&&"objectStoreNames"in IDBTransaction.prototype))return h.return($f(Error("IDBTransaction.prototype.objectStoreNames is missing")));h.j=2;e={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return x(h,Og(e),4);case 4:return x(h,Pg(),5);case 5:return h.return(new Yf(!0));
case 2:f=qa(h);if(!Zf()){h.h=6;break}h.j=7;return x(h,Qg(),9);case 9:return g=h.i,h.return($f(f,g));case 7:return qa(h),h.return($f(f));case 6:return h.return($f(f))}})})}
function Tg(){if(void 0!==Rg)return Rg;Uf=!0;return Rg=Sg().then(function(a){Uf=!1;a.log();return a.isSupported()})}
;var Ug;function Vg(){Ug||(Ug=new Mf("yt.offline"));return Ug}
;function Wg(){N.call(this);this.l=this.u=this.C=this.o=!1;this.i=Xg();this.l=S("validate_network_status");Yg(this);Zg(this)}
ma(Wg,N);function Xg(){var a=window.navigator.onLine;return void 0===a?!0:a}
function Zg(a){window.addEventListener("online",function(){return L(a,function c(){var d=this;return z(c,function(e){if(1==e.h){if(!d.l){d.i=!0;e.h=2;return}return x(e,$g(d),3)}2!=e.h&&(d.i=e.i);d.o&&d.i&&pd(d,"ytnetworkstatus-online");ah(d);if(d.u&&S("offline_error_handling")){var f=Vg().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new ag(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;de(h)}Vg().set("errors",{},2592E3,!0)}}e.h=0})})})}
function Yg(a){window.addEventListener("offline",function(){return L(a,function c(){var d=this;return z(c,function(e){if(1==e.h){if(!d.l){d.i=!1;e.h=2;return}return x(e,$g(d),3)}2!=e.h&&(d.i=e.i);d.o&&!d.i&&pd(d,"ytnetworkstatus-offline");ah(d);e.h=0})})})}
function ah(a){a.C&&(ee(new ag("NetworkStatusManager state did not match poll",T()-0)),a.C=!1)}
function $g(a){return L(a,function c(){var d;return z(c,function(e){switch(e.h){case 1:return e.j=2,x(e,fetch("/generate_204",{method:"HEAD"}),4);case 4:d=!0;e.h=3;e.j=0;break;case 2:qa(e),d=!1;case 3:return e.return(d)}})})}
;function bh(a){a=void 0===a?{}:a;N.call(this);var b=this;this.l=this.u=0;Wg.h||(Wg.h=new Wg);this.i=Wg.h;this.i.o=!0;a.ta&&(this.i.u=!0);a.R?(this.R=a.R,gd(this.i,"ytnetworkstatus-online",function(){ch(b,"publicytnetworkstatus-online")}),gd(this.i,"ytnetworkstatus-offline",function(){ch(b,"publicytnetworkstatus-offline")})):(gd(this.i,"ytnetworkstatus-online",function(){pd(b,"publicytnetworkstatus-online")}),gd(this.i,"ytnetworkstatus-offline",function(){pd(b,"publicytnetworkstatus-offline")}))}
ma(bh,N);function dh(){eh||(eh=new bh({ta:!0}));var a=eh.i;a.l||a.i===Xg()||ee(new ag("NetworkStatusManager isOnline does not match window status"))}
function ch(a,b){a.R?a.l?(Fe(a.u),a.u=Be(function(){a.o!==b&&(pd(a,b),a.o=b,a.l=T())},a.R-(T()-a.l))):(pd(a,b),a.o=b,a.l=T()):pd(a,b)}
;var eh;function fh(a,b){b=void 0===b?{}:b;S("skip_is_supported_killswitch")?Tg().then(function(){dh();Pe(a,b)}):(dh(),Pe(a,b))}
function gh(a,b){b=void 0===b?{}:b;S("skip_is_supported_killswitch")?Tg().then(function(){Pe(a,b)}):Pe(a,b)}
;function hh(a){var b=this;this.h=null;a?this.h=a:Jf()&&(this.h=Af());Ce(function(){Rf(b)},0,5E3)}
hh.prototype.isReady=function(){!this.h&&Jf()&&(this.h=Af());return!!this.h};
function Df(a,b,c,d){!R("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&ee(new ag("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var e=new ag("innertube xhrclient not ready",b,c,d);de(e);throw e;}var f={headers:{"Content-Type":"application/json"},method:"POST",postParams:c,postBodyFormat:"JSON",onTimeout:function(){d.onTimeout()},
onFetchTimeout:d.onTimeout,onSuccess:function(n,r){if(d.onSuccess)d.onSuccess(r)},
onFetchSuccess:function(n){if(d.onSuccess)d.onSuccess(n)},
onError:function(n,r){if(d.onError)d.onError(r)},
onFetchError:function(n){if(d.onError)d.onError(n)},
timeout:d.timeout,withCredentials:!0},g="";(e=a.h.pa)&&(g=e);var h=a.h.ra||!1,k=Kf(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.h.innertubeApiVersion+"/"+b;var l={alt:"json"};a.h.qa&&f.headers.Authorization||(l.key=a.h.innertubeApiKey);var m=we(""+g+e,l||{},!0);(function(n){n=void 0===n?!1:n;var r;if(d.retry&&"www.youtube-nocookie.com"!=g&&(n||(r=Pf(b,c,k,h)),r)){var p=f.onSuccess,v=f.onFetchSuccess;f.onSuccess=function(w,
y){Qf(r);p(w,y)};
c.onFetchSuccess=function(w,y){Qf(r);v(w,y)}}try{n&&d.retry&&!d.aa.bypassNetworkless?(f.method="POST",!d.aa.writeThenSend&&S("nwl_send_fast_on_unload")?gh(m,f):fh(m,f)):(f.method="POST",f.postParams||(f.postParams={}),Pe(m,f))}catch(w){if("InvalidAccessError"==w.name)r&&(Qf(r),r=0),ee(Error("An extension is blocking network request."));
else throw w;}r&&Ce(function(){Rf(a)},0,5E3)})(!1)}
;function ih(a,b){var c=void 0===c?{}:c;var d=hh;R("ytLoggingEventsDefaultDisabled",!1)&&hh==hh&&(d=null);c=void 0===c?{}:c;var e={};e.eventTimeMs=Math.round(c.timestamp||T());e[a]=b;a=C("_lact",window);a=null==a?-1:Math.max(Date.now()-a,0);e.context={lastActivityMs:String(c.timestamp||!isFinite(a)?-1:a)};S("log_sequence_info_on_gel_web")&&c.ca&&(a=e.context,b=c.ca,Ef[b]=b in Ef?Ef[b]+1:0,a.sequence={index:Ef[b],groupKey:b},c.Ma&&delete Ef[c.ca]);(c.Ra?xf:tf)({endpoint:"log_event",payload:e,B:c.B},
d)}
;var jh=[{Y:function(a){return"Cannot read property '"+a.key+"'"},
...
var lh;function mh(){lh||(lh=new kh);return lh}
;var nh=new P;function oh(a){function b(){return a.charCodeAt(d++)}
var c=a.length,d=0;do{var e=ph(b);if(Infinity===e)break;var f=e>>3;switch(e&7){case 0:e=ph(b);if(2===f)return e;break;case 1:if(2===f)return;d+=8;break;case 2:e=ph(b);if(2===f)return a.substr(d,e);d+=e;break;case 5:if(2===f)return;d+=4;break;default:return}}while(d<c)}
function ph(a){var b=a(),c=b&127;if(128>b)return c;b=a();c|=(b&127)<<7;if(128>b)return c;b=a();c|=(b&127)<<14;if(128>b)return c;b=a();return 128>b?c|(b&127)<<21:Infinity}
;function qh(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=rh(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=e;var g=a[e],h=b,k=c;f="string"!==typeof g||"clickTrackingParams"!==f&&"trackingParams"!==f?0:(g=oh(atob(g.replace(/-/g,"+").replace(/_/g,"/"))))?rh(f+".ve",g,h,k):0;d+=f;d+=rh(e,a[e],b,c);if(500<d)break}}else c[b]=sh(a),d+=c[b].length;else c[b]=sh(a),d+=c[b].length;return d}
function rh(a,b,c,d){c+="."+a;a=sh(b);d[c]=a;return c.length+a.length}
function sh(a){return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}
;var th=new Set,uh=0,vh=0,wh=0,xh=[],yh=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];var zh={};function Ah(a){return zh[a]||(zh[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Bh={},Ch=[],Id=new P,Dh={};function Eh(){for(var a=u(Ch),b=a.next();!b.done;b=a.next())b=b.value,b()}
function Fh(a,b){var c;"yt:"===a.tagName.toLowerCase().substr(0,3)?c=a.getAttribute(b):c=a?a.dataset?a.dataset[Ah(b)]:a.getAttribute("data-"+b):null;return c}
function Gh(a,b){for(var c=1;c<arguments.length;++c);Id.I.apply(Id,arguments)}
;function Hh(a){this.j=this.h=!1;this.i=a||{};a=document.getElementById("www-widgetapi-script");if(this.h=!!("https:"===document.location.protocol||a&&0===a.src.indexOf("https:"))){a=[this.i,window.YTConfig||{}];for(var b=0;b<a.length;b++)a[b].host&&(a[b].host=a[b].host.toString().replace("http://","https://"))}}
function Y(a,b){a=[a.i,window.YTConfig||{}];for(var c=0;c<a.length;c++){var d=a[c][b];if(void 0!==d)return d}return null}
function Ih(a,b,c){Jh||(Jh={},oe(window,"message",function(d){a:{if(d.origin===Y(a,"host")||d.origin===Y(a,"host").toString().replace(/^http:/,"https:")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}a.j=!0;a.h||0!==d.origin.indexOf("https:")||(a.h=!0);if(d=Jh[e.id])d.s=!0,d.s&&(J(d.o,d.sendMessage,d),d.o.length=0),d.U(e)}e=void 0}return e}));
Jh[c]=b}
var Jh=null;function Z(a,b,c){this.m=this.h=this.i=null;this.j=0;this.s=!1;this.o=[];this.l=null;this.C={};this.id=Ca(this);this.u=c;this.setup(a,b)}
...
q.U=function(a){Kh(this,a.event,a)};
q.addEventListener=function(a,b){var c=b;"string"===typeof b&&(c=function(){window[b].apply(window,arguments)});
if(!c)return this;this.l.subscribe(a,c);Lh(this,a);return this};
function Mh(a,b){b=b.split(".");if(2===b.length){var c=b[1];a.u===b[0]&&Lh(a,c)}}
q.destroy=function(){this.h&&this.h.id&&(Bh[this.h.id]=null);var a=this.l;a&&"function"==typeof a.dispose&&a.dispose();if(this.m){a=this.h;var b=a.parentNode;b&&b.replaceChild(this.m,a)}else(a=this.h)&&a.parentNode&&a.parentNode.removeChild(a);Jh&&(Jh[this.id]=null);this.i=null;a=this.h;for(var c in Va)Va[c][0]==a&&me(c);this.m=this.h=null};
q.W=function(){return{}};
function Nh(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.s?a.sendMessage(b):a.o.push(b)}
function Kh(a,b,c){a.l.j||(c={target:a,data:c},a.l.I(b,c),Gh(a.u+"."+b,c))}
function Oh(a,b){var c=document.createElement("iframe");b=b.attributes;for(var d=0,e=b.length;d<e;d++){var f=b[d].value;null!=f&&""!==f&&"null"!==f&&c.setAttribute(b[d].name,f)}c.setAttribute("frameBorder","0");c.setAttribute("allowfullscreen","1");c.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");c.setAttribute("title","YouTube "+Y(a.i,"title"));(b=Y(a.i,"width"))&&c.setAttribute("width",b.toString());(b=Y(a.i,"height"))&&c.setAttribute("height",
...
function Ph(a){Ih(a.i,a,a.id);a.j=ge(a.ba.bind(a));oe(a.h,"load",function(){window.clearInterval(a.j);a.j=ge(a.ba.bind(a))})}
q.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?qb(a.src):"https://www.youtube.com"),this.i=new Hh(b),c||(b=Oh(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Ca(this.h)),Bh[this.h.id]=this,window.postMessage){this.l=new P;Ph(this);b=Y(this.i,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Dh)Dh.hasOwnProperty(e)&&
Mh(this,e)}};
function Lh(a,b){a.C[b]||(a.C[b]=!0,Nh(a,"addEventListener",[b]))}
...
void 0);var f=d||{};d="WARNING";d=void 0===d?"ERROR":d;if(e){e.hasOwnProperty("level")&&e.level&&(d=e.level);if(S("console_log_js_exceptions")){var g=e,h=[];h.push("Name: "+g.name);h.push("Message: "+g.message);g.hasOwnProperty("params")&&h.push("Error Params: "+JSON.stringify(g.params));g.hasOwnProperty("args")&&h.push("Error args: "+JSON.stringify(g.args));h.push("File name: "+g.fileName);h.push("Stacktrace: "+g.stack);window.console.log(h.join("\n"),g)}if(!(5<=uh)){g=void 0;var k=f,l=Cc(e);f=l.message||
"Unknown Error";h=l.name||"UnknownError";var m=l.stack||e.i||"Not available";if(m.startsWith(h+": "+f)){var n=m.split("\n");n.shift();m=n.join("\n")}n=l.lineNumber||"Not available";l=l.fileName||"Not available";var r=0;if(e.hasOwnProperty("args")&&e.args&&e.args.length)for(g=0;g<e.args.length&&!(r=qh(e.args[g],"params."+g,k,r),500<=r);g++);else if(e.hasOwnProperty("params")&&e.params){var p=e.params;if("object"===typeof e.params)for(g in p){if(p[g]){var v="params."+g,w=sh(p[g]);k[v]=w;r+=v.length+
w.length;if(500<r)break}}else k.params=sh(p)}if(xh.length)for(g=0;g<xh.length&&!(r=qh(xh[g],"params.context."+g,k,r),500<=r);g++);navigator.vendor&&!k.hasOwnProperty("vendor")&&(k["device.vendor"]=navigator.vendor);g={message:f,name:h,lineNumber:n,fileName:l,stack:m,params:k,sampleWeight:1};f=Number(e.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);if("IGNORED"===e.level)e=0;else a:{e=mh();f=u(e.i);for(h=f.next();!h.done;h=f.next())if(h=h.value,g.message&&g.message.match(h.Na)){e=h.weight;
break a}e=u(e.h);for(f=e.next();!f.done;f=e.next())if(f=f.value,f.La(g)){e=f.weight;break a}e=1}g.sampleWeight=e;e=g;g=u(jh);for(f=g.next();!f.done;f=g.next())if(f=f.value,f.T[e.name])for(n=u(f.T[e.name]),h=n.next();!h.done;h=n.next())if(l=h.value,h=e.message.match(l.regexp)){e.params["params.error.original"]=h[0];n=l.groups;l={};for(m=0;m<n.length;m++)l[n[m]]=h[m+1],e.params["params.error."+n[m]]=h[m+1];e.message=f.Y(l);break}e.params||(e.params={});g=mh();e.params["params.errorServiceSignature"]=
"msg="+g.i.length+"&cb="+g.h.length;e.params["params.serviceWorker"]="false";B.document&&B.document.querySelectorAll&&(e.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));window.yterr&&"function"===typeof window.yterr&&window.yterr(e);if(0!==e.sampleWeight&&!th.has(e.message)){"ERROR"===d?(nh.I("handleError",e),S("record_app_crashed_web")&&0===wh&&1===e.sampleWeight&&(wh++,ih("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),vh++):"WARNING"===d&&nh.I("handleWarning",
e);if(S("kevlar_gel_error_routing")){g=d;h=e;b:{f=u(yh);for(n=f.next();!n.done;n=f.next())if((l=ib)&&0<=l.toLowerCase().indexOf(n.value.toLowerCase())){f=!0;break b}f=!1}if(f)f=void 0;else{n={stackTrace:h.stack};h.fileName&&(n.filename=h.fileName);f=h.lineNumber&&h.lineNumber.split?h.lineNumber.split(":"):[];0!==f.length&&(1!==f.length||isNaN(Number(f[0]))?2!==f.length||isNaN(Number(f[0]))||isNaN(Number(f[1]))||(n.lineNumber=Number(f[0]),n.columnNumber=Number(f[1])):n.lineNumber=Number(f[0]));f={level:"ERROR_LEVEL_UNKNOWN",
...
value:h}),l.kvPairs.push({key:"server.version",value:m}));f={errorMetadata:l,stackTrace:n,logMessage:f}}f&&(ih("clientError",f),("ERROR"===g||S("errors_flush_gel_always_killswitch"))&&vf())}if(!S("suppress_error_204_logging")){f=e;g=f.params||{};d={urlParams:{a:"logerror",t:"jserror",type:f.name,msg:f.message.substr(0,250),line:f.lineNumber,level:d,"client.name":g.name},postParams:{url:R("PAGE_NAME",window.location.href),file:f.fileName},method:"POST"};g.version&&(d["client.version"]=g.version);if(d.postParams){f.stack&&
(d.postParams.stack=f.stack);f=u(Object.keys(g));for(h=f.next();!h.done;h=f.next())h=h.value,d.postParams["client."+h]=g[h];if(g=R("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=u(Object.keys(g)),h=f.next();!h.done;h=f.next())h=h.value,d.postParams[h]=g[h];g=R("SERVER_NAME",void 0);f=R("SERVER_VERSION",void 0);g&&f&&(d.postParams["server.name"]=g,d.postParams["server.version"]=f)}Pe(R("ECATCHER_REPORT_HOST","")+"/error_204",d)}th.add(e.message);uh++}}}}}else throw y;}else console&&console.warn&&
console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function Qh(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function Rh(a){return 0===a.search("get")||0===a.search("is")}
;function Sh(a,b){if(!a)throw Error("YouTube player element ID required.");var c={title:"video player",videoId:"",width:640,height:360};if(b)for(var d in b)c[d]=b[d];Z.call(this,a,c,"player");this.F={};this.playerInfo={}}
ma(Sh,Z);q=Sh.prototype;q.W=function(){var a=Y(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!=window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Y(this.i,"embedConfig")){if(F(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
q.U=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(F(a))for(var c in a)this.F[c]=a[c];break;case "infoDelivery":Th(this,a);break;case "initialDelivery":window.clearInterval(this.j);this.playerInfo={};this.F={};Uh(this,a.apiInterface);Th(this,a);break;default:Kh(this,b,a)}};
function Th(a,b){if(F(b))for(var c in b)a.playerInfo[c]=b[c]}
function Uh(a,b){J(b,function(c){this[c]||("getCurrentTime"==c?this[c]=function(){var d=this.playerInfo.currentTime;if(1==this.playerInfo.playerState){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:Qh(c)?this[c]=function(){this.playerInfo={};
this.F={};Nh(this,c,arguments);return this}:Rh(c)?this[c]=function(){var d=0;
...
function Vh(a){if("iframe"!=a.tagName.toLowerCase()){var b=Fh(a,"videoid");b&&(b={videoId:b,width:Fh(a,"width"),height:Fh(a,"height")},new Sh(a,b))}}
;G("YT.PlayerState.UNSTARTED",-1);G("YT.PlayerState.ENDED",0);G("YT.PlayerState.PLAYING",1);G("YT.PlayerState.PAUSED",2);G("YT.PlayerState.BUFFERING",3);G("YT.PlayerState.CUED",5);G("YT.get",function(a){return Bh[a]});
G("YT.scan",Eh);G("YT.subscribe",function(a,b,c){Id.subscribe(a,b,c);Dh[a]=!0;for(var d in Bh)Bh.hasOwnProperty(d)&&Mh(Bh[d],a)});
G("YT.unsubscribe",function(a,b,c){Hd(a,b,c)});
G("YT.Player",Sh);Z.prototype.destroy=Z.prototype.destroy;Z.prototype.setSize=Z.prototype.setSize;Z.prototype.getIframe=Z.prototype.ia;Z.prototype.addEventListener=Z.prototype.addEventListener;Sh.prototype.getVideoEmbedCode=Sh.prototype.getVideoEmbedCode;Sh.prototype.getOptions=Sh.prototype.getOptions;Sh.prototype.getOption=Sh.prototype.getOption;
Ch.push(function(a){var b=a;b||(b=document);a=Ra(b.getElementsByTagName("yt:player"));var c=b||document;if(c.querySelectorAll&&c.querySelector)b=c.querySelectorAll(".yt-player");else{var d;c=document;b=b||c;if(b.querySelectorAll&&b.querySelector)b=b.querySelectorAll(".yt-player");else if(b.getElementsByClassName){var e=b.getElementsByClassName("yt-player");b=e}else{e=b.getElementsByTagName("*");var f={};for(c=d=0;b=e[c];c++){var g=b.className,h;if(h="function"==typeof g.split)h=0<=Ma(g.split(/\s+/),
"yt-player");h&&(f[d++]=b)}f.length=d;b=f}}b=Ra(b);J(Qa(a,b),Vh)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Eh();var Wh=B.onYTReady;Wh&&Wh();var Xh=B.onYouTubeIframeAPIReady;Xh&&Xh();var Yh=B.onYouTubePlayerAPIReady;Yh&&Yh();}).call(this);
