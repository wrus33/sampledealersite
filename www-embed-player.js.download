...
var W=h.screen.availTop}catch(N){}k=[A,G,k,l,H,W,n,p,r,q];l=b.h.top;try{var R=(l||window).document,M="CSS1Compat"==R.compatMode?R.documentElement:R.body;var ia=(new zc(M.clientWidth,M.clientHeight)).round()}catch(N){ia=new zc(-12245933,-12245933)}R=ia;ia={};M=new ad;y.SVGElement&&y.document.createElementNS&&M.set(0);l=Lc();l["allow-top-navigation-by-user-activation"]&&M.set(1);l["allow-popups-to-escape-sandbox"]&&M.set(2);y.crypto&&y.crypto.subtle&&M.set(3);y.TextDecoder&&y.TextEncoder&&M.set(4);
M=bd(M);ia.bc=M;ia.bih=R.height;ia.biw=R.width;ia.brdim=k.join();b=b.i;b=(ia.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[b.visibilityState||b.webkitVisibilityState||b.mozVisibilityState||""]||0,ia.wgl=!!K.WebGLRenderingContext,ia);c=d.call(c,e,b);c.ca_type="image";a&&(c.bid=a);return c}
...
function si(a,b,c,d){return J(a,function f(){var g=this,h,k,l,n,p,r,q,A,G,H,W,R,M,ia;return x(f,function(N){switch(N.h){case 1:var eb={mode:"readonly",H:!1};"string"===typeof c?eb.mode=c:eb=c;h=eb;g.transactionCount++;k=Q("ytidb_transaction_exponential_backoff_retries");l=h.H?pf("ytidb_transaction_try_count",1):1;n=500;p=0;case 2:if(r){N.h=3;break}p++;q=Math.round(T());N.j=4;A=g.h.transaction(b,h.mode);eb=new xi(A);eb=yi(eb,d);return w(N,eb,6);case 6:return G=N.i,H=Math.round(T()),zi(g,q,H,p,void 0,
b.join(),h),N.return(G);case 4:W=sa(N);R=Math.round(T());M=gi(W,g.h.name,b.join());if((ia=M instanceof V&&!M.h)||p>=l){zi(g,q,R,p,M,b.join(),h);r=M;N.h=2;break}if(!k){N.h=2;break}return w(N,qi(n),9);case 9:n*=2;N.h=2;break;case 3:return N.return(Promise.reject(r))}})})}
...
function jn(a,b,c){var d=b[c];return function(e){for(var f=[],g=0;g<arguments.length;++g)f[g-0]=arguments[g];try{return a.lastError=null,d.apply(b,f)}catch(h){"sendAbandonmentPing"!==c&&(h.params=c,a.lastError=h,vk(h))}}}
...
m.B=function(){dn(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){wk(b)}this.aa=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(y[this.i[a]]=null);this.ga=this.config=this.api=null;delete this.u;delete this.j;L.prototype.B.call(this)};
